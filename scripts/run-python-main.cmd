...
if not defined BASH_EXE (
  echo [python][error] No se encontró bash.exe. Instala Git for Windows o usa WSL.>&2
  exit /b 1
)
...
"%BASH_EXE%" -lc "cd \"$(/usr/bin/cygpath -u \"%ROOT_DIR%\")\" && bash ./scripts/run-python-main.sh %*"
exit /b %ERRORLEVEL%
